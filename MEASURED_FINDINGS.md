...
- K-shot(주 지표 mean±sd, 3시드; Δ = CACHE−RAW; 승 = 시드 승수):
  ...
  - 산사태 AP: random K5 Δ−.0004(0/3), K20 Δ0.0(2/3) · **posaware K5 CACHE .078±.083 vs RAW .0012, Δ+.077(2/3); K20 .115±.051 vs .0025, Δ+.113(3/3)**. 양성 10칩으로 캐시 head 가 FULL_CACHE(.060)를 넘음 → 캐시 표현에 산사태 신호가 있고 소수 라벨로 열림. 같은 지원에서 raw 는 열리지 않음.
