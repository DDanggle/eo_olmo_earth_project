...
**2026-08-25 추가 정정**: `우리별(KITSAT)`은 EO 자산이 아님. 1호는 1992 발사·2004 운용 종료,
2호는 1993 발사인 실험위성임. 현재 운용 중인 한국 지구관측 자산은 아리랑 3호(광학)·
아리랑 5호(C-band SAR)·차세대중형위성 1·2호(0.5/2 m)·4호(5 m)·천리안 2A임.
센서 축을 열 때의 1순위 짝은 **아리랑 5호 ↔ Sentinel-1**임 — 둘 다 C-band라
파장을 고정한 채 플랫폼 효과만 분리할 수 있음. 상세는
`docs/MOUNTAINSHIFT_EXPERIMENT_DESIGN.md` §6.5.
