...
**현재 집중 질문·실행 준비의 최신 해석은 [2026-09-08 갱신형 캐시 큰 그림](BIG_PICTURE_STREAMING_EARTH_2026_09_08.md)으로 이동했다.**
아래 patch-2 진행·2지역 T1 미완료는 당시 상태다. 기존 결과/gate는 보존하며 아래 queue를 새로 실행하지 않는다.
