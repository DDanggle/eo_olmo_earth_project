...
**baseline 물질화 완료**: 5/5 앵커, S1·S2 모두 exact 4 periods, 총 48,859,900 bytes,
...
- **판정**: 사건 delta가 placebo 95 percentile을 넘고, source/corridor 방향이 3 seed/두
  pooling recipe에서 유지될 때만 anomaly라고 쓴다.
