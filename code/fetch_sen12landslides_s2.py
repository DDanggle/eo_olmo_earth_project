...
산출물
  ...
  extracted/    풀어놓은 .nc
  region_index.jsonl   파일별 (region, sensor, id, 파트) — 지역 단위 LOCO의 기반
"""
...
def main() -> None:
    ...
    manifest_p = ROOT / "manifest.jsonl"
    done = set()
    ...
    index_p = ROOT / "region_index.jsonl"
    ...
    summary = {"schema": "sen12landslides-s2-fetch-v1", "repo": REPO,
