...
out={}; allids=set()
for fn in ("holdout_chimanimani","holdout_hiroshima"):
...
(ROOT/"sen12_gp_contract/t1_manifest.json").write_text(json.dumps(out)); (ROOT/"sen12_gp_contract/t1_ids.txt").write_text("\n".join(sorted(allids)))
