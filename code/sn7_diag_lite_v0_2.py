#!/usr/bin/env python3
"""G1-lite v0.2 (config/bottleneck_diag_lite_prereg_v0_2.json): quadrant crops at NATIVE resolution for Q1/Q2, MIN_NEW=8, Q3 dropped, reader Qwen3-VL-8B (run) — otherwise identical to v0.
...
ROOT=Path("/home/work/data/olmoearth"); SN7=ROOT/"spacenet7/train"; OUT=ROOT/"spacenet7/diag_lite_v0_2"; OUT.mkdir(parents=True,exist_ok=True)
